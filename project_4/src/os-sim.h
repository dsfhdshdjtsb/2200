...
/*
 * mark_for_preemption() preempts a running process before its timeslice expires.
...
extern void __wrap_pthread_cond_wait(pthread_cond_t *cond, pthread_mutex_t *mutex);
